...
LOCATION_COORDS = {
    "GATE_1": (50, 50), "GATE_2": (100, 50), "GATE_3": (150, 50), "GATE_4": (200, 50),
    "GATE_5": (250, 50), "GATE_6": (300, 50), "GATE_7": (350, 50), "GATE_8": (400, 50),
    "ZONE_01": (100, 100), "ZONE_02": (200, 100), "ZONE_03": (300, 100), "ZONE_04": (100, 150),
    "ZONE_05": (200, 150), "ZONE_06": (300, 150), "ZONE_07": (100, 200), "ZONE_08": (200, 200),
    "ZONE_09": (300, 200), "ZONE_10": (100, 250), "ZONE_11": (200, 250), "ZONE_12": (300, 250),
}
...
def find_best_volunteer(incident_location: str, incident_desc: str, roster: VolunteerRoster) -> Optional[dict]:
    """
