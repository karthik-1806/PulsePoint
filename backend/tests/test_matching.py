...
def test_matching_skill_weighting():
    ...
    roster = VolunteerRoster(
        volunteers=[
            Volunteer(id="1", name="Alice", skills=["Wayfinding"], assigned_zone_id="ZONE_01"),
            Volunteer(id="2", name="Bob", skills=["First Aid", "Language: Spanish"], assigned_zone_id="ZONE_05"),
        ]
    )
...
def test_matching_distance():
    ...
    roster = VolunteerRoster(
        volunteers=[
            Volunteer(id="1", name="Alice", skills=["General"], assigned_zone_id="ZONE_01"),
            Volunteer(id="2", name="Charlie", skills=["General"], assigned_zone_id="ZONE_10"),
        ]
    )
