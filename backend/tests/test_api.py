...
def test_fan_agent_endpoint():
    ...
    response = client.post("/fan-agent", json={"query": "hello", "language": "English", "step_free": False})
...
def test_ops_agent_incident_unauthenticated():
    ...
    response = client.post("/ops-agent/incident", json={"description": "Test", "location": "ZONE_01"})
