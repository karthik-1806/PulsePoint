...
def simple_linear_regression(y_values: List[float], x_values: List[float] = None) -> callable:
...
def calculate_gate_forecasts(history: List['VenueSnapshot']) -> Dict[str, Dict[str, float]]:
    """
